...
<body id="AAA" 
	...
	";>
	<div id="add">
		<form action="m_user_manage.php#add" method="POST">
			<table align="center" cellspacing="20px">
				<tr><th style="text-decoration: none;color:white;">Add New User</th></tr>
	...
	<div id="edit">
		<form action="m_user_manage.php#edit" method="POST">
			<table align="center" cellspacing="20px">
				<tr><th style="text-decoration: none;color:white;">Edit User</th></tr>
				<tr><td>User ID: 
	...
	<div id="delete">
		<form action="m_user_manage.php#delete" method="POST">
			<table align="center" cellspacing="20px">
				<tr><th style="text-decoration: none;color:white;">Delete User</th></tr>
				<tr><td>User ID: 
