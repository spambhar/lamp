...
<body id="AAA" 
	...
	<div id="add">
		<form action="m_venue_manage.php#add" method="POST">
			<table align="center" cellspacing="20px">
				<tr><th style="text-decoration: none;color:white;">Add New Venue</th></tr>
	...
	<div id="edit">
		<form action="m_venue_manage.php#edit" method="POST">
			<table align="center" cellspacing="20px">
				<tr><th style="text-decoration: none;color:white;">Edit Venue</th></tr>
				<tr><td>Venue: 
	...
	<div id="delete">
		<form action="m_venue_manage.php#delete" method="POST">
			<table align="center" cellspacing="20px">
				<tr><th style="text-decoration: none;color:white;">Delete Venue</th></tr>
				<tr><td>Venue: 
